...
class HoshPluginForm_System_List_Helper_Task_SetChangeOrderElement extends HoshPluginForm_System_List_Helper_Task_Factory
{
	public function render($options){
		...
		$package_form_element = new Hosh_Manager_Db_Package_Hosh_List_Element();
