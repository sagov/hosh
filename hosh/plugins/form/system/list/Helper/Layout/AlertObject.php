...
class HoshPluginForm_System_List_Helper_Layout_AlertObject extends Hosh_Form_Helper_Abstract
{
    ...
    public function render ($options)
    {
        ...
        if ($obj->isLock()){
            ...
            $xhtml .=  $view->Bootstrap_Modal()->render('FormInfoModalLock',$xhtml_modal,array('title'=>'List # '.$form->getData('id'),'footer'=>$xhtml_modal_footer));
