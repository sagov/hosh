...
class HoshPluginForm_System_Listelement_Helper_Layout_Default extends Hosh_Form_Helper_Abstract
{
    ...
    public function render ($options)
    {
        ...
        $view->AddScript('/plugins/form/system/listelement/js/script.js');
        $param = array();
        if ($form->isEdit()) {
        ...
        $script = '
			...
			(function($){
				$(document).ready(function(){
					$("#ElementFormModal").plugin_system_listelement_default(' .
                 json_encode($param) . ');
				});				
			})(jQuery);	';
