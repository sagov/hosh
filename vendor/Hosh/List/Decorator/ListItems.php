 ...
 */
class Hosh_List_Decorator_ListItems extends Hosh_List_Decorator_Abstract
{
    ...
    public function render($content)
    {
        ...
        if ((!$list instanceof Hosh_List)) {
            return $content;
        }

        $separator      = $this->getSeparator();
        $translator     = $list->getTranslator();
        $view           = $list->getView();
        $items = $list->getItems();
        $item_render = array();
        ...
        $elementContent = implode($separator, $item_render);
