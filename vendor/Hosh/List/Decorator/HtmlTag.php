...
/**
 * @see Hosh_List_Decorator_Abstract
 */
require_once 'Hosh/List/Decorator/Abstract.php';

/**
 * Hosh_List_Decorator_Element_HtmlTag
 *
 ...
 */
class Hosh_List_Decorator_HtmlTag extends Hosh_List_Decorator_Abstract
{
    /**
     ...
     *
     * @param  string $tag
     * @return Hosh_List_Decorator_HtmlTag
     */
