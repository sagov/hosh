 ...
 */
abstract class Hosh_List_Decorator_Abstract implements Hosh_List_Decorator_Interface
{
    /**
     * Placement constants
     */
    ...
    /**
     * @var Hosh_List_Element|Hosh_List
     */
    protected $_element;
     ...
     *
     * @param  array $options
     * @return Hosh_List_Decorator_Abstract
     */
     ...
     *
     * @param  Hosh_List_Element|Hosh_List|Hosh_List_Item $element
     * @return Hosh_List_Decorator_Abstract
     * @throws Hosh_List_Decorator_Exception on invalid element type
     */
    public function setElement($element)
    {
        if ((!$element instanceof Hosh_List_Element)
            && (!$element instanceof Hosh_List)
            && (!$element instanceof Hosh_List_Item)
            )
        {
            require_once 'Zend/Form/Decorator/Exception.php';
            throw new Hosh_List_Decorator_Exception('Invalid element type passed to decorator');
        }
     ...
     *
     * @return Hosh_List_Element|Hosh_List
     */
     ...
     * @return string
     * @throws Hosh_List_Decorator_Exception when unimplemented
     */
    public function render($content)
    {
        require_once 'Zend/Form/Decorator/Exception.php';
        throw new Hosh_List_Decorator_Exception('render() not implemented');
    }
}
